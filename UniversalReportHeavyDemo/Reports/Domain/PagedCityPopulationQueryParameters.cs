...
namespace UniversalReportHeavyDemo.Reports.Domain
{
    ...
    {
        public PagedCityPopulationQueryParameters(IReportColumnDefinition[] columns, int? pageIndex, string? sort, int? itemsPerPage, int[]? cohortIds, FilterConfig<CityPopulation> filterConfig,
