...
namespace UniversalReportCore.Ui
{
    ...
    public class ColumnFilterTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            sb.Append($"<button class=\"btn btn-primary btn-sm dropdown-toggle\" type=\"button\" id=\"dropdownMenuButton{Column.PropertyName}\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\">");
